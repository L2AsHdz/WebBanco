            ...
            <div class="row">
                <div class="col-xl-8">
                    <c:choose>
                        <c:when test="${!empty(solicitudes)}">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <a href="${pageContext.request.contextPath}/exportarRC?reporte=r5" class="btn default-color btn-sm">
                                        <i class="fas fa-download"></i> Descargar
                                    </a>
                                </div>
                                <div class="card-body">
                                    <table id="reporteC5" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="solicitud" items="${solicitudes}" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>${solicitud.cuenta.cliente.nombre}</td>
                        ...
                        <c:otherwise>
                            <h4>No se ha enviado ninguna solicitud</h4>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
