...
public class SolicitudDAOImpl implements SolicitudDAO {
    ...
    public List<Solicitud> getSolicitudesPendientes(String codCliente) {
        String sql = "SELECT s.id, s.codCuenta, u.nombre, u.noIdentificacion, s.estado, s.fecha FROM "
                + "solicitudAsociacion s INNER JOIN usuario u ON s.codCliente=u.codigo INNER JOIN"
                + " cuenta c ON s.codCuenta=c.codigo where c.codigoCliente=?";
